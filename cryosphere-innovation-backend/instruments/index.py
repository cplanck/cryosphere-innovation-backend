...
class DeploymentModelIndex(AlgoliaIndex):
    ...
    fields = ('id', 'name', 'instrument', 'status', 'details',
              'deployment_start_date', 'deployment_end_date', 'location', 'algolia_index')

    settings = {
        'searchableAttributes': ['algolia_index', 'status', 'deployment_start_date', 'deployment_end_date', 'location', 'details']
    }
